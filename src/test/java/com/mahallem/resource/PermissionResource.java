...
public class PermissionResource {
    ...
    public static Permission permissionAddHome = Permission.builder()
                                                           .fromUserId(new ObjectId("5eb6a52256d8a1577c49621d"))
                                                           .toUserId(new ObjectId("5eb6a49f56d8a1577c49621b"))
                                                           .permissionType(PermissionType.ADD_HOME)
                                                           .build();

    public static Permission permissionTaskAssign = Permission.builder()
                                                              .fromUserId(new ObjectId("5eb6a52256d8a1577c49621d"))
                                                              .toUserId(new ObjectId("5eb6a49f56d8a1577c49621b"))
                                                              .taskId(new ObjectId("5eb8054656d8a15448079ba0"))
                                                              .permissionType(PermissionType.ASSIGN_TASK)
                                                              .build();

    public static PermissionResponse permissionResponse = PermissionResponse.builder()
                                                                            .fromUserId("5eb6a52256d8a1577c49621d")
